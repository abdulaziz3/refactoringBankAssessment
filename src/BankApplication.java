...
public class BankApplication extends JFrame {
	...
	public void initComponents() {
		...
		nextItemButton = new JButton(new ImageIcon("images/next.png"));
		prevItemButton = new JButton(new ImageIcon("images/prev.png"));
		firstItemButton = new JButton(new ImageIcon("images/first.png"));
		lastItemButton = new JButton(new ImageIcon("images/last.png"));
